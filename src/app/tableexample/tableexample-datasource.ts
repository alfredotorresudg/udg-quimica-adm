...
const EXAMPLE_DATA: TableexampleItem[] = [
  {id: 1, name: 'Hydrogen'},
  {id: 2, name: 'Helium'},
  {id: 3, name: 'Lithium'},
  {id: 4, name: 'Beryllium'},
...
export class TableexampleDataSource extends DataSource<TableexampleItem> {
  data: TableexampleItem[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: TableexampleItem[]): TableexampleItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: TableexampleItem[]): TableexampleItem[] {
